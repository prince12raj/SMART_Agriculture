...
def dashboard():
    ...
    lang = session.get('language', 'en')          # ← GET USER'S LANGUAGE
    t = get_all_translations(lang)                 # ← BUILD TRANSLATIONS DICT
    return render_template('dashboard.html', t=t) # ← PASS t TO TEMPLATE
